...
const buttonVariants = cva(
    'inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0',
    {
        variants: {
            variant: {
                default:
                    'bg-primary-dark text-white shadow hover:bg-primary-darker',
                white: 'bg-white text-primary-darker shadow hover:bg-primary-darker hover:text-white',

                whiteLight:
                    'bg-white text-primary-darker shadow hover:bg-primary hover:text-white',
                dark: 'bg-primary-dark text-white shadow hover:bg-primary-darker hover:text-white',
            },
            size: {
