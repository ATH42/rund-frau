...
const Angebote: NextPage = () => {
    return (
        <div>
            ...
            <section className="flex w-full flex-col items-center gap-20 bg-variable-collection-middle-dark-purple px-28 py-20">
                {/* Header section */}
                <div className="flex w-full flex-col items-center gap-10">
                    ...
                    <p className="text-center text-lg text-variable-collection-white">
                        Alle Angebote können einzeln oder im Paket in Anspruch
                        genommen werden.
                    </p>
                </div>
            ...
            <Image
                ...
                alt="Jeferson santu"
                src="/jeferson-santu-mqyokhepmdu-unsplash.png"
                width={1000}
                height={400}
            />
