...
const Hero: React.FC = () => {
    return (
        ...
        >
            ...
            <Card
                className={`flex w-full flex-1 bg-white p-6 md:w-1/2 md:p-12 lg:p-16`}
            >
                <CardContent className="flex flex-col items-start space-y-4 md:items-start md:justify-center md:space-y-6">
                    <Image
                        ...
                        priority
                    />
                    <p className="text-left font-ink-blossoms text-header text-primary-dark">
            ...
            <Card className="relative flex w-full flex-1 md:w-1/2">
                ...
                >
                    <div
                        className={`absolute inset-0 z-10 bg-primary-dark opacity-30`}
                    ></div>
                    <Image
