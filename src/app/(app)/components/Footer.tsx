                ...
                <div className="relative z-10 flex w-full flex-col items-center gap-12 px-6 py-16 lg:flex-row lg:items-start lg:px-32">
                    ...
                    <div className="w-full space-y-6 text-center text-white lg:w-1/2 lg:text-left">
                        ...
                        <p className="font-text text-content md:text-lg">
                            Auf der Reise durch deine Schwangerschaft, Geburt
                            und Wochenbett suchst du eine Hebamme, die dich
                            sieht, im Blick behält und deinen Fähigkeiten
                            vertraut. Begleitend tragen wir Hebammen unser
                            Wissen, unsere Erfahrungen und das klassische
                            Handwerk im Gepäck.
                        </p>
                    </div>
                </div>
            ...
            <footer className="relative z-10 w-full px-6 pb-16 pt-24 lg:px-32">
                <div className="flex flex-col gap-12 lg:flex-row">
                    <div className="flex-1 space-y-6 text-center lg:text-left">
                        <h2 className="font-h1-new text-3xl font-semibold text-white md:text-4xl">
                            Kontaktiert uns.
                        </h2>
